...
for chunk in census_2017:
    chunk = chunk[(chunk['SOURCE_DESC'] == 'CENSUS') & (chunk['SECTOR_DESC'] == 'CROPS') & (chunk['PRODN_PRACTICE_DESC'] == 'ALL PRODUCTION PRACTICES') | (chunk['PRODN_PRACTICE_DESC'] == 'IN THE OPEN') & (chunk['UNIT_DESC'] == 'ACRES') | (chunk['UNIT_DESC'] == 'OPERATIONS')&
                  (chunk['DOMAIN_DESC'] == 'TOTAL') & (chunk['DOMAINCAT_DESC'] == 'NOT SPECIFIED')& (chunk['GROUP_DESC'] == 'FIELD CROPS') | (chunk['GROUP_DESC'] == 'VEGETABLES') | (chunk['GROUP_DESC'] == 'FRUIT & TREE NUTS')]
